        ...
        {topVenues.map((venue) => (
          <SwiperSlide key={venue.id}>
            <Link to={`/venue/${venue.id}`} className="w-full">
              <div className="w-full h-100 bg-white dark:bg-customBgDark-500 shadow-md rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 mb-10">
